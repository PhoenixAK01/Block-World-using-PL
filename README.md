...
Checks if the current state equals the goal state.
If depth limit is not reached, generates all valid moves.
Avoids revisiting states to prevent cycles.
Accumulates the sequence of moves (Path).
Solution Printing
